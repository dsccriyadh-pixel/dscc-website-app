    ...
    <footer className="bg-primary text-primary-foreground mt-24">
      <div className="container py-16 grid grid-cols-2 lg:grid-cols-12 gap-10">
        <div className="col-span-2 lg:col-span-4">
          <div className="font-serif text-3xl font-semibold mb-4">DSCC</div>
          <p className="text-primary-foreground/75 text-sm leading-relaxed max-w-sm">
            {t("footer.company_desc")}
          </p>
          <div className="mt-6 flex items-center gap-3">
            <a href="#" aria-label="LinkedIn" className="rounded-full border border-primary-foreground/20 p-2 hover:bg-primary-foreground/10">
        ...
        <div className="col-span-1 lg:col-span-2">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/services" className="hover:text-secondary transition-colors">{t("nav.services")}</Link></li>
            <li><Link href="/sectors" className="hover:text-secondary transition-colors">{t("nav.sectors")}</Link></li>
            <li><Link href="/projects" className="hover:text-secondary transition-colors">{t("nav.projects")}</Link></li>
            <li><Link href="/resources" className="hover:text-secondary transition-colors">{t("nav.resources")}</Link></li>
          </ul>
        </div>
        ...
        <div className="col-span-1 lg:col-span-2">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/clients" className="hover:text-secondary transition-colors">{t("nav.clients")}</Link></li>
            <li><Link href="/quote" className="hover:text-secondary transition-colors">{t("nav.quote")}</Link></li>
        ...
        <div className="col-span-2 lg:col-span-4">
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/85">
            <li className="flex items-start gap-2"><MapPin className="size-4 mt-0.5 shrink-0 text-secondary" /> Olaya Towers, Riyadh 12244, KSA</li>
            <li className="flex items-center gap-2"><Phone className="size-4 text-secondary" /> +966 11 200 1234</li>
            <li className="flex items-center gap-2"><Mail className="size-4 text-secondary" /> hello@dscc-sa.com</li>
          </ul>
          ...
          >
            ...
            />
            <Button type="submit" variant="secondary" size="sm">{t("footer.subscribe")}</Button>
          </form>
        </div>
      </div>
